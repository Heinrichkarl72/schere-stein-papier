<script lang="ts">
	import { LayoutGrid, Swords, Shield, Settings, ChevronRight, Target, Trophy, Dices } from 'lucide-svelte';
	...
	const menuItems = $derived([
		...
		{ id: 'blackjack', label: 'BLACKJACK', icon: Dices, href: `${base}/blackjack` },
